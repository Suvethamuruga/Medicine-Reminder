...
var mname=document.getElementById("medicine-name").value;
...
function ringing(now){
    audio.play();
    alert(`Hey! it's time to take ${now}`)
}
...
addAlarm.addEventListener('submit', e=> {
   ...
   var newAlarm = `${new_h}:${new_m}:${new_s}`
	var newAlarm1=document.getElementById("medicine-name").value;
